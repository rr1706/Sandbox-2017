...
//		rotationMotor.setAnalogPosition(MathUtils.unwrapCAN(rotationMotor.getAnalogInPosition()));
		 ...
		 */
		rawError = angleError;
//		if (Math.abs(rotationMotor.getError()) > 256) {
...
//		SmartDashboard.putBoolean("Reversed" + id, wheelReversed);
...
//		SmartDashboard.putNumber("Sensor " + id, rotationMotor.getAnalogInPosition());
//		SmartDashboard.putNumber("A Command " + id, this.angleCommand);
//		SmartDashboard.putNumber("Z Command " + id, -z);
//		SmartDashboard.putNumber("Error " + id, rotationMotor.getError());
//		SmartDashboard.putNumber("I " + id, i);
//		SmartDashboard.putNumber("J " + id, j);
//		SmartDashboard.putNumber("K " + id, k);
